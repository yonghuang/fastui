...
fastDev.Util.position = {
     ...
     */
    locate: function (target, reference, context, margin, allowAdjustHeight) {
        ...
        allowAdjustHeight = allowAdjustHeight === false ? false : true;
        ...
        var rect = fastDev.Util.position.getBoundingRect(reference, path),
            ...
            offset = {
                ...
                top: (lower > height || (decrease && !allowAdjustHeight)) ? top : upper > lower ? rect.top - height - margin : top
            }, targetHeight;
