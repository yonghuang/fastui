...
(function () {
	...
	//URL= "../../../../library/thirdparty/ueditor/";
	var  getRootPath=function() {
       var pathName = window.location.pathname.substring(1);
       var webName = pathName == '' ? '' : pathName.substring(0, pathName.indexOf('/')); 
       return window.location.protocol + '//' + window.location.host + '/'+ webName+"/";
     };
    var tmp = window.location.pathname,rootpath=getRootPath(),URL= rootpath+"library/thirdparty/ueditor/"; 
    ...
    UEDITOR_CONFIG = {
        ...
        catcherUrl:URL +"server/submit/jsp/getRemoteImage.jsp",             //处理远程图片抓取的地址
        localDomain:"baidu.com",                                        //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地
	    imageManagerPath:URL + "server/submit/jsp/imageManager.jsp",       //图片在线浏览的处理地址
        ...
        snapscreenServerFile: URL +"server/upload/jsp/snapImgUp.jsp", //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ...
        messages:{
            ...
            snapScreenMsg:'截图上传失败，请检查你的jsp环境。 '
        },
